...
class BootstrapServiceProvider extends ServiceProvider
{
    ...
    protected array $configs = ['html_purifier', 'fields', 'integrations', 'settings'];
    ...
    public function boot(): void
    {
        ...
        // The core module is loaded last because of the resource related routes but,
        // we will make sure that the helper files are included first in this provider.
        require_once module_path('Core', 'app/Support/helpers.php');
    }
